...
class F{// object 
   public static void main(String[] args) {
     ...
     A first = new A();// calling the method for clas A
     C middle= new C();// calling method for class C
     E last= new E();// calling method for class E
    
    first.MO();//We all know 'A' got start!
    //Yeah, Then 'B' comes next, so easy, huh!
    
    middle.TATA();//"So, C and D.
